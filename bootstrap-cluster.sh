...
echo "---- Bootstrapping complete ----"# delete kind cluster if it exists, create a new one
...
# EOF
#
# kubectl apply -f manifests/vault-secrets/argocd-auth-vault-secret.yaml
# kubectl create -f manifests/vault-secrets/ghcr-auth-vault-secret.yaml
#
# # # install argocd
